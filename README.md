...
Nothing is given about  Alice (__A__), Bob (__B__) and the trusted 3rd party (__S__), therefore _all_ their key-pairs have to be generated by you. In addition, you will also have to generate the __nonce__ values for Alice and Bob.
...
* There must be exactly 4 entries: the details of __A__, __B__ and __S__ (the RSA keys for all 3 parties and nonce values you generate for __A__ and __B__) and the communication between them as specified by the protocol provided in the coursework description.
...
```json
{
    ...
    "communication":[
        ...
        {
            "text" : "Dear A, Here is B-s public key [258659] signed by me. Yours sincerely, S.",
        ...
        {
            "text" : "Dear B, Here is A-s public key [226321] signed by me. Yours sincerely, S.",
...
```json
{
    ...
    "communication" : [
        ...
        {
            "text" : "Dear A, Here is B-s public key [29203] signed by me. Yours sincerely, S.",
        ...
        {
            "text" : "Dear B, Here is A-s public key [119279] signed by me. Yours sincerely, S.",
